...
The library is cross-built for __Scala 2.11__ and __Scala 2.12__. The core module to use is `"org.criteo.lolhttp" %% "lolhttp" % "0.3.2"`.

There are also 2 optional companion libraries:

- `"org.criteo.lolhttp" %% "loljson" % "0.3.2"`, provides integration with the [circe](https://circe.github.io/circe/) JSON library.
- `"org.criteo.lolhttp" %% "lolhtml" % "0.3.2"`, provides minimal HTML templating.
