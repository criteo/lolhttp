...
The core module to use is `"com.criteo.lolhttp" %% "lolhttp" % "0.4.1"`.

There are also 2 optional companion libraries:

- `"com.criteo.lolhttp" %% "loljson" % "0.4.1"`, provides integration with the [circe](https://circe.github.io/circe/) JSON library.
- `"com.criteo.lolhttp" %% "lolhtml" % "0.4.1"`, provides minimal HTML templating.
