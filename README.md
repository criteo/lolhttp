...
The core module to use is `"com.criteo.lolhttp" %% "lolhttp" % "0.9.0"`.

There are also 2 optional companion libraries:

- `"com.criteo.lolhttp" %% "loljson" % "0.9.0"`, provides integration with the [circe](https://circe.github.io/circe/) JSON library.
- `"com.criteo.lolhttp" %% "lolhtml" % "0.9.0"`, provides minimal HTML templating.
